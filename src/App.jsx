    ...
    <header className="bg-white shadow-md px-6 py-4 flex items-center justify-between relative z-50">
      ...
      <section className="max-w-full h-[500px] mx-auto px-8 py-12 flex flex-col md:flex-row md:items-start md:justify-between bg-white rounded-xl shadow-sm mb-8">
        ...
        <div className="flex-1 mb-8 md:mb-0 md:pr-12">
          ...
          <p className="text-gray-700 text-lg">King Kane Goa understands how crucial mobility is and is dedicated to offering its customers with high-quality car rental services at affordable rates. For the best automobile rental service in Goa, go no further than King Kane Car Rentals. We provide both manual and automatic transmission automobiles, ideal for both leisure and business journeys.<br/><br/>Whether you’re looking for a high-end sports utility vehicle, SUV or an economy car, we have you covered. Because we accept upcountry customers as well, you can easily book your self-drive car or get car rental services. Please browse all of our rental cars in Goa for self drive or particular trip packages below. We ensure all your transportation needs are met and that you’re as comfortable as possible in Goa.</p>
        </div>
